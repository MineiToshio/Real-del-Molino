...
if (!$errors) {
	...
	<body>
	<table>
		<tr><td colspan=2>Este es un mensaje enviado desde la página Web de Real del Molino</td></tr>
	...
	if ($_POST) {
		...
		else echo 'Ha ocurrido un error inesperado. Por favor intentar en unos momentos.';
